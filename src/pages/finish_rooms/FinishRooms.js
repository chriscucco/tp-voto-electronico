...
function FinishRooms() {
    ...
    useEffect(() => {
        const init = async () => {
            ...
            const roomInfoRequest = await fetch(`/rooms/show/all/not_ready_for_review`)
    ...
    const goToRoomDetail = (roomId) => navigate(`/finish_room/${roomId}`);
