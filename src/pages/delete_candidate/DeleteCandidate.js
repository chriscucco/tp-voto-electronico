...
function DeleteCandidate() {
  ...
  const onFinish = (values) => {
    ...
    fetch('/candidates/delete', requestOptions).then( function(response) {
      if (response.ok){
        setShowModal(true)
        setSuccess(true)
        handleOpen()
    ...
    <div>
      ...
      <Row gutter={[24, 24]} style={{ marginTop: topMargin}}>
        <Col span={24} align='middle'>
          <Title level={4}>Ingresar identificador del candidato para eliminarlo</Title>
        </Col>
        <Col span={24} align='middle'>
          <Form onFinish={onFinish}>
            <Form.Item
              label="Candidato"
              name="candidateId"
              rules={[{ required: true, message: 'Identificador del candidato requerido' }]}
            ...
            <Col span={24} align='middle'>
              ...
              >
                <Box sx={{ ...style, width: 400, alignItems:'center', alignContent:'center', alignSelf:'center' }}>
                  ...
                  <p align='center' id="parent-modal-description">
                    Error en los datos ingresados, candidato inválido.
                  </p>
                  {
                    <Col span={24} align='middle'>
