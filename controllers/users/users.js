...
exports.createUser = async(req, res) => {
    ...
    const validParams = validateParams(user_id, name, last_name)
    ...
    const response = await createUser(user_id, name, last_name)
